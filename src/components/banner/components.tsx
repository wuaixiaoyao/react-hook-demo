...
export const Item = styled.div`
  text-align: center;
  padding: 100px;
  background-image: ${(props: ItemProps) => `url(${props.img})`};
  background-size: cover;
`;

export const CarouselContainer = styled.div`
  display: flex;
  transition: ${(props: CarouselContainerProps) => (props.sliding ? "none" : "transform 1s ease")};
...
export const SlideButton = styled.button`
  ...
  margin-top: 20px;
  text-decoration: none;
  float: ${(props: SlideButtonProps) => props.float};
